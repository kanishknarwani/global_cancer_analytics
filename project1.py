...
'''
INFERENCE - The analysis demonstrates that early_stage diagnosis for various cancer types is relatively widespread, with 
most cancers having an early diagnosis rate between 38.43% and 40.41%. Liver cancer shows the highest proportion, while
lung cancer shows the lowest. These findings suggest that while screening and diagnostic methods are effective, improvements 
can still be made, particularly in lung cancer detection.

Further research into screening strategies, early intervention, and the use of advanced diagnostic technologies could help
increase the proportion of early_stage diagnosis, ultimately lending to better survival rates and outcomes for cancer
patients. The relatively small variations across the cancer types indiate that, in general, healthcare systems may need to 
focus on enhancing early detection uniformly, with targeted efforts to address specific gaps in detection, particularly
for cancers like lung cancer. 
'''
...
'''
INFERENCE - For Severiy_Score -> Since value of Pearson's and Spearman's coefficient for Smoking is 0.484 and 0.478 it shows
strong positive correlation. Higher smoking levels are associated with higher severity score.

For Survival_Years -> Since value of Pearson's and Spearman's coefficient is almost 0.00 that means negligible or negative 
correlation. These variables do not show any significant linear or monotonic association with survival duration. 
'''
...
'''
INFERENCE - This graph shows variation caused by a particular feature while it is combined with other features.
smoking 0.2336 Most imp predictor of severity score. The more a patient smokes, the higher severity tends to
be.
...
'''
INFERENCE - The information in your coloumns does not help the model to figure out how long a person will survive 
'''
...
'''
INFERENCE - Geographic Disparities in Economic Burden:
Cancer treatment costs are significantly higher in developed nations such as the USA, Australia, and China, 
revealing the heavy financial load in advanced healthcare systems. Meanwhile, countires like India and Pakistan
exhibit comparatively lower costs, likely due to lower healthcare pricing structures or limited access to 
advanced treatment. This highlights a clear global inequality in healthcare affordability that can intensify
financial strain depending on a patient's country or residence

Gender Based Cost Patterns are Uniform:
Across all countries, gender-based differences in average treatment costs are minimal, suggesting no major gender
bias in pricing or access to cancer care. This uniformity in may reflect standardization in treatment protocols 
or equitable healthcare policies, but it also points to the fact that the financial impact of cancer is universal 
across genders.

Age-Related Escalation in Treatment Costs:
Treatment costs tend to rise with age, particulary for those aged 61 above. This trend is espacially evident in 
countries like Australia and the USA, where older age groups face sharply higher costs. The increased financial 
burden in these groups could be due to more intensive care needs, multiple comorbidities, or prolonged treatments.
This pattern underlines the vulnerability of elderly populations and the pressing need for targeted support for 
senior citizens.

Role of Healthcare Systems in cost variation:
Countries with robust public healthcare systems such as Canada, Germany, and the UK; show relatively stable 
treatment costs across age groups, reflecting the benefits of healthcare subsidies or coverage. This consistency
reinforces the importance of Government intervention and Universal healthcare in mitigating financial 
disparities in cancer treatment. 
'''

# Assessing whether higher treatment cost is associated with longer survival 
...
'''
INFERENCE - According the coefficient we can observe that there is no correlation between treatment
cost and suvival years. From Hypothesis testing also we can conclude that there is no correlation 
between treatment cost and suvival years.
'''
...
# Finding - There is no change in treatment cost as well as average survival years is stage increases

# Test the same through Hypothesis testing 
...
# Check whether the groups are norally distrubuted or not 
normal_survival = 0
normal_cost = 0
...
# Test this from kruskal wallis test
...
'''
INFERENCE
p - value = 0.42; No significant difference in treatment cost among cancer stages; We don't reject Null

p - value = 0.60; No significant difference in survival years among cancer stages; We don't reject Null
'''

# Examine whether higher genetic risk amplifies the negative effects of smoking on cancer severity

#Null Hypothesis: The interaction effect between genetic risk and smoking on Cancer Severity is not 
#significant. (Genetic risk does not amplify or alter the effect of smoking)

#Alternate Hypothesis: The interaction effect between genetic risk and smoking on Cancer Severity is 
#significant. (Genetic risk does amplify or alter the effect of smoking)                                              
...
The interaction effect between genetic risk and smoking on target severity score is not statistically 
significant ( p value > 0.05)
This means that based on your data, there is no evidence that genetic risk amplifies or reduces the effect 
of smoking on the target severity score
In other words, smoking and genetic risk may each have independent effects(or none), but they do not
interact in a way that significantly change the outcome. 
'''
